package com.draik.mobileorg.Synchronizers;
...
import com.draik.mobileorg.util.FileUtils;
...
public class Synchronizer {
	public static final String SYNC_UPDATE = "com.draik.mobileorg.Synchronizer.action.SYNC_UPDATE";
