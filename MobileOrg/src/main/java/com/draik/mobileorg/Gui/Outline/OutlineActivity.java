package com.draik.mobileorg.Gui.Outline;
...
import com.draik.mobileorg.Gui.Agenda.AgendasActivity;
import com.draik.mobileorg.Gui.Wizard.WizardActivity;
import com.draik.mobileorg.OrgData.OrgProviderUtils;
import com.draik.mobileorg.Services.SyncService;
import com.draik.mobileorg.Settings.SettingsActivity;
import com.draik.mobileorg.Synchronizers.Synchronizer;
import com.draik.mobileorg.util.OrgUtils;
import com.draik.mobileorg.util.PreferenceUtils;
...
public class OutlineActivity extends SherlockActivity {
    ...
    public final static String SYNC_FAILED = "com.draik.mobileorg.SYNC_FAILED";
	...
	public void runHelp(View view) {
		Intent intent = new Intent(Intent.ACTION_VIEW,
				Uri.parse("https://github.com/draik/mobileorg-android/wiki"));
